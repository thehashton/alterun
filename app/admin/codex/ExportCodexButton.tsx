...
export function ExportCodexButton() {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={loading}
      className="btn-hover flex items-center gap-2 rounded border border-alterun-border bg-alterun-bg-card px-4 py-2 text-base text-alterun-muted transition-[border-color,background-color,color] duration-200 hover:border-alterun-gold/50 hover:bg-alterun-gold/10 hover:text-alterun-gold disabled:opacity-60 disabled:hover:border-alterun-border disabled:hover:bg-alterun-bg-card disabled:hover:text-alterun-muted"
    >
