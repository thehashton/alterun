  ...
  render: () => (
    <div className="flex flex-col gap-12 items-center">
      <div className="flex flex-col items-center gap-2">
        <span className="text-xl font-display text-alterun-gold uppercase tracking-wider">Header logo</span>
      ...
      <div className="flex flex-col items-center gap-2">
        <span className="text-xl font-display text-alterun-gold uppercase tracking-wider">Short (A)</span>
      ...
      <div className="flex flex-col items-center gap-2">
        <span className="text-xl font-display text-alterun-gold uppercase tracking-wider">Detailed (hero)</span>
