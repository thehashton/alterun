  ...
  render: () => (
    <div className="flex flex-wrap gap-8">
      <div className="flex flex-col items-center gap-2 text-alterun-gold">
        ...
        <span className="text-sm font-display">New entry</span>
      </div>
      <div className="flex flex-col items-center gap-2 text-alterun-gold">
        <IconCategories className="h-8 w-8" />
        <span className="text-sm font-display">Categories</span>
      </div>
      <div className="flex flex-col items-center gap-2 text-alterun-gold">
        <IconPlus className="h-8 w-8" />
        <span className="text-sm font-display">Plus</span>
      </div>
      <div className="flex flex-col items-center gap-2 text-alterun-gold">
        <IconDownload className="h-8 w-8" />
        <span className="text-sm font-display">Download</span>
      </div>
    </div>
  ),
};
